...
* Unterschied zur Patientenbildung: noch kein automatisiertes Ground-Truth-/Proxy-Dataset, fachliche Validierung der Treffer läuft noch, aktuell keine direkte Weiterentwicklung
* leitet die Lesson ein: Validierbarkeit entscheidet, wann aus einem Prototyp eine tragende Story wird

**Visual:** Zwei Beispiel-Kacheln nebeneinander auf derselben Zonen-Map: „Patientenbildung - validiert" (grün) vs. „Abrechnungsanomalien - in Validierung" (gelb).
...
* durchgängiges Beispiel: Patientenbildung als Patient Record Linkage; Abrechnungsanomalien als zweites Beispiel
